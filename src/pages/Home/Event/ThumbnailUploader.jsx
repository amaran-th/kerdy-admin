...
const ImageUploader = ({ title, isEdit, thumbnailPath, setThumbnail }) => {
    ...
    return (
        <div className="flex h-full flex-col space-y-[10px]">
          ...
          relative flex h-60 w-40 items-center justify-center border-dashed !border-pointBlue/30 hover:opacity-70
        `}
            >
                {thumbnailBase64 ? (
                    <img
